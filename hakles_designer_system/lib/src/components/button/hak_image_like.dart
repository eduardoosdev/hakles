...
class HakImageLikeButton extends StatefulWidget {
  ...
  /// Height of [HakImageLikeButton].
  final double? height;

  /// width of [HakImageLikeButton].
  final double? width;
  ...
  @override
  _HakImageLikeButtonState createState() => _HakImageLikeButtonState();
}

class _HakImageLikeButtonState extends State<HakImageLikeButton>
