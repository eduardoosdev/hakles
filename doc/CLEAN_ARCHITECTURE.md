...
A Camada **Presentation** fica responsável por declarar as entradas, saídas e interações da aplicação. 
...
Foi desenvolvido a CLI [ft_cli](https://pub.dev/packages/ft_cli) que auxilia na criação da estrutura em clean, onde temos um templete base no projeto modelo.
